...
namespace RetailStoreWebApp.Core.Contexts.Data;
...
public partial class ProjectDatabaseContext : DbContext
{
    ...
    public virtual DbSet<CustomersNew> CustomersNews { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomersNew>(entity =>
        {
            entity.HasKey(e => e.CustomerId);

            entity.ToTable("CustomersNew");
        });
